    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-73px)] p-6">
      <div className="w-full max-w-md p-8 bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Sign in to your digital wardrobe</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-black text-white dark:bg-white dark:text-black rounded-xl font-bold text-lg hover:opacity-90 transition-opacity disabled:opacity-50"
          >
        ...
        <p className="mt-8 text-center text-gray-500">
          ...
          <Link href="/register" className="text-purple-500 font-medium hover:underline">
            Register for free
          </Link>
        </p>
      </div>
